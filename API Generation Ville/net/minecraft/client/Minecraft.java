...
import ironcraft.doubi125.town.gui.GuiModelSelection;
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                            	displayGuiScreen(new GuiModelSelection(TownGenerator.generator.getModels()));
//                            	TownGenerator.generator.genTest(theWorld, (int)thePlayer.posX, (int)thePlayer.posY, (int)thePlayer.posZ);
                            }
                            
                            if(Keyboard.getEventKey() == 45)
                            {
                            	TownGenerator.generator.undo(theWorld);
                            }
//                            else Out.sendMessage(Keyboard.getEventKey());
                        }
