...
public class NetServerHandler extends NetHandler
{
    ...
    public void handleCustomPayload(Packet250CustomPayload par1Packet250CustomPayload)
    {
         ...
         * toulonais
         */
       if ("MC|TrSelT".equals(par1Packet250CustomPayload.channel))
        {
            try
            {
                ...
                if (container instanceof ContainerMerchantToulonais)
                {
                    ((ContainerMerchantToulonais)container).func_75175_c(i);
                }
            }
