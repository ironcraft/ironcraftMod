...
public class Item
{
     ...
     * Piece ors
     */
	 public static Item fuckingCashOrs = (new Item(513)).setIconCoord(239, 239).setItemName("Pieces Ors");;
	 public static Item fuckingCashArgent = (new Item(514)).setIconCoord(14, 13).setItemName("Pieces Argent");;
	 public static Item fuckingCashBronze = (new Item(515)).setIconCoord(207, 207).setItemName("Pieces Bronze");;
    /** Item index + 256 */
    ...
    static
    {
    	fuckingCashOrs = (new Item(513)).setIconCoord(239, 239).setItemName("PiecesOrs").func_77637_a(CreativeTabs.field_78035_l);
    	fuckingCashArgent = (new Item(514)).setIconCoord(14, 13).setItemName("PiecesArgent").func_77637_a(CreativeTabs.field_78035_l);
       	fuckingCashBronze = (new Item(515)).setIconCoord(13, 13).setItemName("PiecesBronze").func_77637_a(CreativeTabs.field_78035_l);
        ...
        field_77702_n = (new Item(132)).setIconCoord(10, 11).setItemName("emerald").func_77637_a(CreativeTabs.field_78035_l);
        StatList.initStats();
    }
}
