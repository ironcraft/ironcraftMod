...
import net.minecraft.TradeToulonais.*;
...
public class NetClientHandler extends NetHandler
{
    ...
    public void handleOpenWindow(Packet100OpenWindow par1Packet100OpenWindow)
    {
        ...
        switch (par1Packet100OpenWindow.inventoryType)
        {
            ...
            case 7:
                entityclientplayermp.fonc_Marchant(new NpcMerchantToulonais(entityclientplayermp));
                ((EntityPlayerSP)(entityclientplayermp)).craftingInventory.windowId = par1Packet100OpenWindow.windowId;
                break;
        }
    }
    ...
    public void handleCustomPayload(Packet250CustomPayload par1Packet250CustomPayload)
    {
         ...
         * Mod marchant
         */
         if ("MC|TrListT".equals(par1Packet250CustomPayload.channel))
        {
            ...
            try
            {
                ...
                if (guiscreen != null && (guiscreen instanceof GuiMerchantToulonais) && i == mc.field_71439_g.craftingInventory.windowId)
                {
                    IMerchantToulonais imerchant = ((GuiMerchantToulonais )guiscreen).func_74199_h();
                    MerchantRecipeListToulonais  merchantrecipelist = MerchantRecipeListToulonais .func_77204_a(datainputstream);
