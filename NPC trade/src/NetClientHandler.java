...
import net.minecraft.TradeToulonais.NpcMerchantToulonais;
import net.minecraft.client.Minecraft;
import org.lwjgl.input.Keyboard;

public class NetClientHandler extends NetHandler
{
    private boolean field_55324_f;
    ...
    public NetClientHandler(Minecraft par1Minecraft, IntegratedServer par2IntegratedServer) throws IOException
    {
        ...
        par2IntegratedServer.func_56414_ae().func_56969_a((MemoryConnection)netManager, par1Minecraft.session.username);
    }
    ...
    {
        if (!field_55324_f && netManager != null)
        {
    ...
    public void func_55318_a(Packet253ServerAuthData par1Packet253ServerAuthData)
    {
        String s = par1Packet253ServerAuthData.func_55159_b().trim();
        java.security.PublicKey publickey = par1Packet253ServerAuthData.func_55158_c();
        javax.crypto.SecretKey secretkey = CryptManager.func_55332_a();

        if (!"-".equals(s))
        {
            String s1 = (new BigInteger(CryptManager.func_55335_a(s, publickey, secretkey))).toString(16);
            String s2 = func_55323_a(mc.session.username, mc.session.sessionId, s1);
        ...
        addToSendQueue(new Packet252SharedKey(secretkey, publickey, par1Packet253ServerAuthData.func_58066_d()));
    }

    private String func_55323_a(String par1Str, String par2Str, String par3Str)
    {
        try
        {
            URL url = new URL((new StringBuilder()).append("http://session.minecraft.net/game/joinserver.jsp?user=").append(func_55322_a(par1Str)).append("&sessionId=").append(func_55322_a(par2Str)).append("&serverId=").append(func_55322_a(par3Str)).toString());
    ...
    private static String func_55322_a(String par0Str) throws IOException
    {
    ...
    {
        mc.field_56453_c = new PlayerControllerMP(mc, this);
        mc.statFileWriter.readStat(StatList.joinMultiplayerStat, 1);
        worldClient = new WorldClient(this, new WorldSettings(0L, par1Packet1Login.field_56535_d, false, par1Packet1Login.field_56536_c, par1Packet1Login.terrainType), par1Packet1Login.field_48170_e, par1Packet1Login.difficultySetting);
        worldClient.isRemote = true;
        mc.func_56445_a(worldClient);
        mc.field_56455_h.dimension = par1Packet1Login.field_48170_e;
        mc.displayGuiScreen(new GuiDownloadTerrain(this));
        mc.field_56455_h.entityId = par1Packet1Login.field_55171_a;
        currentServerMaxPlayers = par1Packet1Login.maxPlayers;
        mc.field_56453_c.func_57521_a(par1Packet1Login.field_56535_d);
        addToSendQueue(new Packet204ClientInfo(mc.gameSettings.language, mc.gameSettings.renderDistance, mc.gameSettings.field_55382_n, mc.gameSettings.field_55383_o, mc.gameSettings.difficulty));
    }
    ...
    public void handleVehicleSpawn(Packet23VehicleSpawn par1Packet23VehicleSpawn)
    {
        ...
        {
            obj = new EntityFallingSand(worldClient, d, d1, d2, par1Packet23VehicleSpawn.throwerEntityId & 0xfff, par1Packet23VehicleSpawn.throwerEntityId >> 12);
            par1Packet23VehicleSpawn.throwerEntityId = 0;
        }
    ...
    public void handleNamedEntitySpawn(Packet20NamedEntitySpawn par1Packet20NamedEntitySpawn)
    {
        ...
        EntityOtherPlayerMP entityotherplayermp = new EntityOtherPlayerMP(mc.field_56452_f, par1Packet20NamedEntitySpawn.name);
    ...
    {
        EntityClientPlayerMP entityclientplayermp = mc.field_56455_h;
        ...
        if (!field_1210_g)
        {
            mc.field_56455_h.prevPosX = mc.field_56455_h.posX;
            mc.field_56455_h.prevPosY = mc.field_56455_h.posY;
            mc.field_56455_h.prevPosZ = mc.field_56455_h.posZ;
            field_1210_g = true;
    ...
    public void func_48487_a(Packet51MapChunk par1Packet51MapChunk)
    {
        ...
        if (chunk != null)
        {
            chunk.func_48494_a(par1Packet51MapChunk.func_56567_b(), par1Packet51MapChunk.yChMin, par1Packet51MapChunk.yChMax, par1Packet51MapChunk.includeInitialize);
    ...
    public void handleCollect(Packet22Collect par1Packet22Collect)
    {
        ...
        if (entity != null)
        {
            ...
            mc.effectRenderer.addEffect(new EntityPickupFX(mc.field_56452_f, entity, ((Entity)(obj)), -0.5F));
    ...
    {
        mc.ingameGUI.func_55092_b().func_55106_a(par1Packet3Chat.message);
    }
    ...
    public void handleAnimation(Packet18Animation par1Packet18Animation)
    {
        ...
        else if (par1Packet18Animation.animate != 4)
        {
            ...
            {
                mc.effectRenderer.addEffect(new EntityCrit2FX(mc.field_56452_f, entity));
            }
            else if (par1Packet18Animation.animate == 7)
            {
                EntityCrit2FX entitycrit2fx = new EntityCrit2FX(mc.field_56452_f, entity, "magicCrit");
    ...
    public void handleMobSpawn(Packet24MobSpawn par1Packet24MobSpawn)
    {
        ...
        EntityLiving entityliving = (EntityLiving)EntityList.createEntityByID(par1Packet24MobSpawn.type, mc.field_56452_f);
    ...
    {
        mc.field_56452_f.setWorldTime(par1Packet4UpdateTime.time);
    }

    public void handleSpawnPosition(Packet6SpawnPosition par1Packet6SpawnPosition)
    {
        mc.field_56455_h.setSpawnChunk(new ChunkCoordinates(par1Packet6SpawnPosition.xPosition, par1Packet6SpawnPosition.yPosition, par1Packet6SpawnPosition.zPosition));
        mc.field_56452_f.getWorldInfo().setSpawnPosition(par1Packet6SpawnPosition.xPosition, par1Packet6SpawnPosition.yPosition, par1Packet6SpawnPosition.zPosition);
    }
    ...
    public void handleAttachEntity(Packet39AttachEntity par1Packet39AttachEntity)
    {
        ...
        if (par1Packet39AttachEntity.entityId == mc.field_56455_h.entityId)
        {
            obj = mc.field_56455_h;

            if (entity instanceof EntityBoat)
            {
                ((EntityBoat)entity).func_56182_a(false);
            }
        }
        else if (entity instanceof EntityBoat)
        {
            ((EntityBoat)entity).func_56182_a(true);
        }
    ...
    {
        if (par1 == mc.field_56455_h.entityId)
        {
            return mc.field_56455_h;
        }
        else
        {
    ...
    {
        mc.field_56455_h.setHealth(par1Packet8UpdateHealth.healthMP);
        mc.field_56455_h.getFoodStats().setFoodLevel(par1Packet8UpdateHealth.food);
        mc.field_56455_h.getFoodStats().setFoodSaturationLevel(par1Packet8UpdateHealth.foodSaturation);
    }
    ...
    {
        mc.field_56455_h.setXPStats(par1Packet43Experience.experience, par1Packet43Experience.experienceTotal, par1Packet43Experience.experienceLevel);
    }
    ...
    {
        if (par1Packet9Respawn.respawnDimension != mc.field_56455_h.dimension)
        {
            field_1210_g = false;
            worldClient = new WorldClient(this, new WorldSettings(0L, par1Packet9Respawn.field_56537_d, false, mc.field_56452_f.getWorldInfo().isHardcoreModeEnabled(), par1Packet9Respawn.terrainType), par1Packet9Respawn.respawnDimension, par1Packet9Respawn.difficulty);
            worldClient.isRemote = true;
            mc.func_56445_a(worldClient);
            mc.field_56455_h.dimension = par1Packet9Respawn.respawnDimension;
            mc.displayGuiScreen(new GuiDownloadTerrain(this));
        }

        mc.func_56438_a(par1Packet9Respawn.respawnDimension);
        mc.field_56453_c.func_57521_a(par1Packet9Respawn.field_56537_d);
    }

    public void handleExplosion(Packet60Explosion par1Packet60Explosion)
    {
        Explosion explosion = new Explosion(mc.field_56452_f, null, par1Packet60Explosion.explosionX, par1Packet60Explosion.explosionY, par1Packet60Explosion.explosionZ, par1Packet60Explosion.explosionSize);
        explosion.field_58127_g = par1Packet60Explosion.field_58068_e;
        explosion.doExplosionB(true);
        mc.field_56455_h.motionX += par1Packet60Explosion.func_56529_b();
        mc.field_56455_h.motionY += par1Packet60Explosion.func_56530_c();
        mc.field_56455_h.motionZ += par1Packet60Explosion.func_56528_d();
    }
    ...
    public void handleOpenWindow(Packet100OpenWindow par1Packet100OpenWindow)
    {
        ...
        switch (par1Packet100OpenWindow.inventoryType)
        {
            ...
            case 4:
                ...
                break;
            case 7:
                entityclientplayermp.func_56241_a2(new NpcMerchantToulonais(entityclientplayermp));
                ((EntityPlayerSP)(entityclientplayermp)).craftingInventory.windowId = par1Packet100OpenWindow.windowId;
                break;
            case 6:
                entityclientplayermp.func_56241_a(new NpcMerchant(entityclientplayermp));
                ((EntityPlayerSP)(entityclientplayermp)).craftingInventory.windowId = par1Packet100OpenWindow.windowId;
                break;
    ...
    public void handleSetSlot(Packet103SetSlot par1Packet103SetSlot)
    {
        ...
        else
        {
            ...
            if (mc.currentScreen instanceof GuiContainerCreative)
            {
                ...
                flag = guicontainercreative.func_58065_g() != CreativeTabs.field_57056_m.func_57038_b();
            }
    ...
    {
        if (mc.field_56452_f.blockExists(par1Packet130UpdateSign.xPosition, par1Packet130UpdateSign.yPosition, par1Packet130UpdateSign.zPosition))
        {
            TileEntity tileentity = mc.field_56452_f.getBlockTileEntity(par1Packet130UpdateSign.xPosition, par1Packet130UpdateSign.yPosition, par1Packet130UpdateSign.zPosition);
    ...
    {
        if (mc.field_56452_f.blockExists(par1Packet132TileEntityData.xPosition, par1Packet132TileEntityData.yPosition, par1Packet132TileEntityData.zPosition))
        {
            TileEntity tileentity = mc.field_56452_f.getBlockTileEntity(par1Packet132TileEntityData.xPosition, par1Packet132TileEntityData.yPosition, par1Packet132TileEntityData.zPosition);
    ...
    public void handlePlayerInventory(Packet5PlayerInventory par1Packet5PlayerInventory)
    {
        ...
        if (entity != null)
        {
            entity.func_56179_b(par1Packet5PlayerInventory.slot, par1Packet5PlayerInventory.func_56569_b());
        }
    }

    public void handleCloseWindow(Packet101CloseWindow par1Packet101CloseWindow)
    {
        mc.field_56455_h.closeScreen();
    }

    public void handlePlayNoteBlock(Packet54PlayNoteBlock par1Packet54PlayNoteBlock)
    {
        mc.field_56452_f.playNoteAt(par1Packet54PlayNoteBlock.xLocation, par1Packet54PlayNoteBlock.yLocation, par1Packet54PlayNoteBlock.zLocation, par1Packet54PlayNoteBlock.instrumentType, par1Packet54PlayNoteBlock.pitch);
    }

    public void func_56713_a(Packet55BlockDestroy par1Packet55BlockDestroy)
    {
        mc.field_56452_f.func_56837_h(par1Packet55BlockDestroy.func_56548_b(), par1Packet55BlockDestroy.func_56547_c(), par1Packet55BlockDestroy.func_56546_d(), par1Packet55BlockDestroy.func_56545_e(), par1Packet55BlockDestroy.func_56544_f());
    }
    ...
    public void handleBed(Packet70GameEvent par1Packet70GameEvent)
    {
        ...
        {
            mc.field_56453_c.func_57521_a(EnumGameType.func_57536_a(j));
        }
        else if (i == 4)
        {
        ...
        else if (i == 5)
        {
            ...
            {
                mc.ingameGUI.func_55092_b().func_56468_a("demo.help.movement", new Object[]
                        {
            ...
            {
                mc.ingameGUI.func_55092_b().func_56468_a("demo.help.jump", new Object[]
                        {
            ...
            {
                mc.ingameGUI.func_55092_b().func_56468_a("demo.help.inventory", new Object[]
                        {
    ...
    public void handleMapData(Packet131MapData par1Packet131MapData)
    {
        ...
        {
            ItemMap.getMPMapData(par1Packet131MapData.uniqueID, mc.field_56452_f).func_28171_a(par1Packet131MapData.itemData);
        }
        else
        {
    ...
    {
        mc.field_56452_f.playAuxSFX(par1Packet61DoorChange.sfxID, par1Packet61DoorChange.posX, par1Packet61DoorChange.posY, par1Packet61DoorChange.posZ, par1Packet61DoorChange.auxData);
    }
    ...
    {
        mc.field_56455_h.incrementStat(StatList.getOneShotStat(par1Packet200Statistic.statisticId), par1Packet200Statistic.amount);
    }
    ...
    {
        EntityClientPlayerMP entityclientplayermp = mc.field_56455_h;
        ((EntityPlayer)(entityclientplayermp)).capabilities.isFlying = par1Packet202PlayerAbilities.func_56564_c();
        ((EntityPlayer)(entityclientplayermp)).capabilities.isCreativeMode = par1Packet202PlayerAbilities.func_56556_e();
        ((EntityPlayer)(entityclientplayermp)).capabilities.disableDamage = par1Packet202PlayerAbilities.func_56563_b();
        ((EntityPlayer)(entityclientplayermp)).capabilities.allowFlying = par1Packet202PlayerAbilities.func_56557_d();
        ((EntityPlayer)(entityclientplayermp)).capabilities.func_57526_a(par1Packet202PlayerAbilities.func_56560_f());
    }

    public void func_55321_a(Packet203AutoComplete par1Packet203AutoComplete)
    {
        String as[] = par1Packet203AutoComplete.func_55174_b().split("\0");

        if (mc.currentScreen instanceof GuiChat)
        {
            GuiChat guichat = (GuiChat)mc.currentScreen;
            guichat.func_55150_a(as);
        }
    }

    public void func_56714_a(Packet62LevelSound par1Packet62LevelSound)
    {
        mc.field_56452_f.func_56841_a(par1Packet62LevelSound.func_56575_c(), par1Packet62LevelSound.func_56571_d(), par1Packet62LevelSound.func_56576_e(), par1Packet62LevelSound.func_56574_b(), par1Packet62LevelSound.func_56573_f(), par1Packet62LevelSound.func_56572_g());
    }
    ...
    public void handleCustomPayload(Packet250CustomPayload par1Packet250CustomPayload)
    {
        if ("MC|TPack".equals(par1Packet250CustomPayload.channel))
        {
            ...
            if (as[1].equals("16"))
            {
                if (mc.texturePackList.func_57501_g() || mc.func_56443_w().func_57429_a())
                {
                    mc.texturePackList.func_57499_a(s);
                }
                else if (mc.texturePackList.func_57502_f())
                {
        ...
        else if ("MC|TrList".equals(par1Packet250CustomPayload.channel))
        {
            ...
            try
            {
                ...
                if (guiscreen != null && (guiscreen instanceof GuiMerchant) && i == mc.field_56455_h.craftingInventory.windowId)
                {
                    IMerchant imerchant = ((GuiMerchant)guiscreen).func_56485_g();
                    MerchantRecipeList merchantrecipelist = MerchantRecipeList.func_57492_a(datainputstream);
                    imerchant.func_56217_a(merchantrecipelist);
                }
            }
            catch (IOException ioexception)
            {
    ...
    public NetworkManager func_56761_e()
    {
        return netManager;
    }
}
