...
import net.minecraft.TradeToulonais.GuiMerchantToulonais;
...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    public EntityPlayerSP(Minecraft par1Minecraft, World par2World, Session par3Session, int par4)
    {
        ...
        {
            skinUrl = (new StringBuilder()).append("http://s3.amazonaws.com/MinecraftSkins/").append(StringUtils.func_55394_a(par3Session.username)).append(".png").toString();
        }
    ...
    public void onLivingUpdate()
    {
        ...
        if (mc.field_56453_c.func_57519_a())
        {
            posX = posZ = 0.5D;
            posX = 0.0D;
            posZ = 0.0D;
    ...
    public void func_55087_a(ItemStack par1ItemStack)
    {
        Item item = par1ItemStack.getItem();

        if (item == Item.field_55216_bG)
        {
            mc.displayGuiScreen(new GuiScreenBook(this, par1ItemStack, false));
        }
        else if (item == Item.field_55215_bF)
        {
    ...
    {
        mc.effectRenderer.addEffect(new EntityCrit2FX(mc.field_56452_f, par1Entity));
    }

    public void onEnchantmentCritical(Entity par1Entity)
    {
        EntityCrit2FX entitycrit2fx = new EntityCrit2FX(mc.field_56452_f, par1Entity, "magicCrit");
    ...
    {
        mc.effectRenderer.addEffect(new EntityPickupFX(mc.field_56452_f, par1Entity, this, -0.5F));
    }
    ...
    {
        mc.ingameGUI.func_55092_b().func_56468_a(par1Str, new Object[0]);
    }
    ...
    {
        mc.ingameGUI.func_55092_b().func_55106_a(par1Str);
    }

    public boolean func_55084_b(String par1Str)
    {
        return worldObj.getWorldInfo().func_55400_u();
    }
}
