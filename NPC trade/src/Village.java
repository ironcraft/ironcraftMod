...
public class Village
{
    ...
    public void tick(int par1)
    {
        ...
        int i = numVillagers / 32;

        if (numIronGolems < i && villageDoorInfoList.size() > 20 && worldObj.rand.nextInt(1) == 0)
        {
    ...
    private Vec3 tryGetIronGolemSpawningLocation(int par1, int par2, int par3, int par4, int par5, int par6)
    {
        for (int i = 0; i < 10; i++)
        {
            ...
            {
                return Vec3.func_58128_a().func_58134_a(j, k, l);
            }
        }
    ...
    {
        if (!worldObj.func_58081_i(par1, par2 - 1, par3))
        {
            return false;
        }
    ...
    {
        List list = worldObj.getEntitiesWithinAABB(net.minecraft.src.EntityIronGolem.class, AxisAlignedBB.func_58144_a().func_58153_a(center.posX - villageRadius, center.posY - 4, center.posZ - villageRadius, center.posX + villageRadius, center.posY + 4, center.posZ + villageRadius));
        numIronGolems = list.size();
    }

    private void updateNumVillagers()
    {
        List list = worldObj.getEntitiesWithinAABB(net.minecraft.src.EntityVillager.class, AxisAlignedBB.func_58144_a().func_58153_a(center.posX - villageRadius, center.posY - 4, center.posZ - villageRadius, center.posX + villageRadius, center.posY + 4, center.posZ + villageRadius));
    ...
    private void updateVillageRadiusAndCenter()
    {
        ...
        villageRadius = Math.max(128, (int)Math.sqrt(j) + 1);
    }
}
