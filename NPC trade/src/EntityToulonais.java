...
public class EntityToulonais extends EntityAgeable implements IMerchantToulonais, INpc
{
    ...
    private void func_56231_i(int par1)
    {
        ...
        switch (getProfession())
        {
            ...
            case 3:
                ...
                func_56225_a(merchantrecipelist, Item.field_56819_n.shiftedIndex, rand, 0.5F);
            ...
            case 1:
                ...
                func_56225_a(merchantrecipelist, Item.field_55216_bG.shiftedIndex, rand, 0.3F);
            ...
            case 2:
                ...
                for (int k = 0; k < j; k++)
                {
                    ...
                    {
                        merchantrecipelist.add(new MerchantRecipe(new ItemStack(l, 1, 0), new ItemStack(Item.diamond, 2 + rand.nextInt(3), 0), EnchantmentHelper.func_57624_a(rand, new ItemStack(l, 1, 0), 5 + rand.nextInt(15))));
                    }
                }
    ...
    static
    {
        ...
        field_56235_at.put(Integer.valueOf(Item.field_56819_n.shiftedIndex), new Tuple(Integer.valueOf(4), Integer.valueOf(6)));
        ...
        field_56235_at.put(Integer.valueOf(Item.field_55216_bG.shiftedIndex), new Tuple(Integer.valueOf(1), Integer.valueOf(1)));
