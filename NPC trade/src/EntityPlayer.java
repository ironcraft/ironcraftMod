...
public abstract class EntityPlayer extends EntityLiving implements ICommandSender
{
    ...
    protected void updateItemUse(ItemStack par1ItemStack, int par2)
    {
        ...
        if (par1ItemStack.getItemUseAction() == EnumAction.eat)
        {
            ...
            {
                Vec3 vec3 = Vec3.func_58128_a().func_58134_a(((double)rand.nextFloat() - 0.5D) * 0.10000000000000001D, Math.random() * 0.10000000000000001D + 0.10000000000000001D, 0.0D);
                vec3.rotateAroundX((-rotationPitch * (float)Math.PI) / 180F);
                vec3.rotateAroundY((-rotationYaw * (float)Math.PI) / 180F);
                Vec3 vec3_1 = Vec3.func_58128_a().func_58134_a(((double)rand.nextFloat() - 0.5D) * 0.29999999999999999D, (double)(-rand.nextFloat()) * 0.59999999999999998D - 0.29999999999999999D, 0.59999999999999998D);
    ...
    public void onLivingUpdate()
    {
        ...
        landMovementFactor = capabilities.func_57528_b();
        jumpMovementFactor = speedInAir;

        if (isSprinting())
        {
            landMovementFactor += (double)capabilities.func_57528_b() * 0.29999999999999999D;
    ...
    protected void alertWolves(EntityLiving par1EntityLiving, boolean par2)
    {
        ...
        List list = worldObj.getEntitiesWithinAABB(net.minecraft.src.EntityWolf.class, AxisAlignedBB.func_58144_a().func_58153_a(posX, posY, posZ, posX + 1.0D, posY + 1.0D, posZ + 1.0D).expand(16D, 4D, 16D));
        Iterator iterator = list.iterator();
    ...
    public void func_56241_a(IMerchant imerchant)
    {
    }
    public void func_56241_a2(IMerchantToulonais imerchanttoulonais)
    {
    }
    public void func_55087_a(ItemStack itemstack)
    {
    }

    public boolean func_56243_e(Entity par1Entity)
    {
        ...
        if (itemstack != null && (par1Entity instanceof EntityLiving))
        {
            ...
            if (itemstack.func_56992_a((EntityLiving)par1Entity))
            {
    ...
    public EnumStatus sleepInBedAt(int par1, int par2, int par3)
    {
        if (!worldObj.isRemote)
        {
            ...
            double d = 8D;
            double d1 = 5D;
            List list = worldObj.getEntitiesWithinAABB(net.minecraft.src.EntityMob.class, AxisAlignedBB.func_58144_a().func_58153_a((double)par1 - d, (double)par2 - d1, (double)par3 - d, (double)par1 + d, (double)par2 + d1, (double)par3 + d));
    ...
    public void moveEntityWithHeading(float par1, float par2)
    {
        ...
        if (capabilities.isFlying && ridingEntity == null)
        {
            ...
            jumpMovementFactor = capabilities.func_57527_a();
    ...
    {
        return capabilities.field_57531_e;
    }
    ...
    public void func_58026_a(EntityPlayer par1EntityPlayer, boolean par2)
    {
        if (par2)
        {
        ...
        field_56244_a = par1EntityPlayer.field_56244_a;
    }
    ...
    public void func_56240_a(EnumGameType enumgametype)
    {
    }
    ...
    {
        return func_55089_aK().translateKeyFormat(par1Str, par2ArrayOfObj);
    }
