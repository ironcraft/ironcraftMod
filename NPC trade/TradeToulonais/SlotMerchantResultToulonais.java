...
public class SlotMerchantResultToulonais extends Slot
{
    ...
    private final IMerchantToulonais field_57194_h;
    ...
    {
        func_48434_c(par1ItemStack);
        MerchantRecipeToulonais merchantrecipe = field_57193_a.func_56192_h();
    ...
    private boolean func_57190_a(MerchantRecipeToulonais par1MerchantRecipe, ItemStack par2ItemStack, ItemStack par3ItemStack)
    {
